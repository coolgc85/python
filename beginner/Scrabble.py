...
#
# Scrabble is a game where players get points by spelling words. Words are scored by adding together
# the point values of each individual letter (we'll leave out the double and triple letter and word scores for now).
#
...
def scrabble_score(word):
    scoreFinal = 0
    for letter in word:
        if score.get(letter.lower()):
           scoreFinal += score.get(letter.lower())
    return scoreFinal



print(scrabble_score("Galo"))
